...
import static com.example.android.booklistings.BookAdapter.LOG_TAG;
        ...
        try {
            ...
            if (baseJsonResponse.has("items")) {
                ...
                for (int i = 0; i < bookArray.length(); i++) {
                    ...
                    /** Create a new {@link Book} object with the image, title, authors and the url from the JSON response.
                     * */
                    Book book = new Book(smallThumbnail, title, authors.toString(), url);
